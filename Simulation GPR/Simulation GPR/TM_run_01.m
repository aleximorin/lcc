...
hold on
plot(txline_01,tzline_01,'r')% plot de la trajectoire 
...
hold on
plot(txline_01,tzline_01,'r')           %plot de la trajectoire du drone 
...
%% Plot the results and save data to file 
figure(1)
datafile = ['GPRdata01_',datestr(now,'mm-dd-HHMM'),'.mat'];
save(datafile,'ep3','mu3','sig3','x3','z3','co_data','pos','t');
figurefile = ['GPRfigure01_',datestr(now,'mm-dd-HHMM'),'.jpg'];
